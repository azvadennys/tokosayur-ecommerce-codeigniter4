        ...
        <div class="col-lg-6 col-5 text-right">
          <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
              ...
              <li class="breadcrumb-item"><?php echo anchor('admin_customers', 'Pelanggan'); ?></li>
          ...
          <div class="card-body p-0">
            <table class="table align-items-center table-flush table-hover">
              ...
              <tr>
                ...
                <td><b><?php echo get_formatted_date($customer->created_at); ?></b></td>
              </tr>
            </table>
          </div>
                ...
                <tbody>
                  <?php foreach ($orders as $order) : ?>
                    <tr>
                      ...
                      <td>
                        <?php echo anchor('admin_orders/view/' . $order->id, '#' . $order->order_number); ?>
                      </td>
                      <td>
                ...
                <tbody>
                  <?php foreach ($payments as $payment) : ?>
                    <tr>
                      ...
                      <td>
                        <?php echo anchor('admin_payments/view/' . $payment->id, $payment->order_number); ?>
                      </td>
                      <td>
  ...
  <script>
    $(document).ready(function() {
      ...
      $('#deleteCustomer').submit(function(e) {
        ...
        $.ajax({
          method: 'POST',
          url: '<?php echo base_url('admin_customers/api/delete'); ?>',
          data: {
            id: id
          },
          success: function(res) {
            if (res.code == 204) {
              ...
              setTimeout(() => {
                window.location = '<?php echo base_url('admin_customers'); ?>';
              }, 4000);
            }
          }
        })
