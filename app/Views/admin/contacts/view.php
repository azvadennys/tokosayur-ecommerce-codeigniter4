  ...
  <div class="row">
          ...
          <div class="card-body p-0">
            <table class="table align-items-center table-flush table-hover">
              ...
              <tr>
                <td>Pesan</td>
                <td>
                  <div style="white-space: initial;"><b><?php echo $contact->message; ?></b></div>
                </td>
              </tr>
              <tr>
                <td>Tanggal</td>
    ...
    <div class="col-md-7">
      <div class="card card-primary">
        ...
        <form action="<?php echo base_url('admin_contacts/reply'); ?>" method="POST">
          ...
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <div class="form-error text-danger font-weight-bold"> <?= $validation->getError('to'); ?></div>
            </div>
            <div class="form-group">
  ...
  <script>
    $(document).ready(function() {
      ...
      $('#deleteContact').submit(function(e) {
        ...
        $.ajax({
          method: 'POST',
          url: '<?php echo base_url('admin/contacts/api/delete'); ?>',
          data: {
            id: id
          },
          success: function(res) {
            if (res.code == 204) {
              ...
              setTimeout(() => {
                window.location = '<?php echo base_url('admin/contacts'); ?>';
              }, 4000);
            }
          }
        })
