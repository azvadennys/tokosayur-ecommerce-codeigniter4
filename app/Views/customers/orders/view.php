...
<section class="ftco-section ftco-Keranjang Belanja">
    <div class="container">
        ...
        <div class="card card-primary">
            <div class="card-header" style="background: #82ae46; color :white;">
                <h5 class="card-heading" style="color :white;">Data Penerima</h5>
            </div>
            <div class="card-body p-0">
                <table class="table table-hover table-striped table-hover">
                    <tr>
                        <td style="background: #82ae46; color :white;">Nama</td>
                        <td><b><?php echo $delivery_data->customer->name; ?></b></td>
                    </tr>
                    <tr>
                        <td style="background: #82ae46; color :white;">No. HP</td>
                        <td><b><?php echo $delivery_data->customer->phone_number; ?></b></td>
                    </tr>
                    <tr>
                        <td style="background: #82ae46; color :white;">Alamat</td>
                        <td><b><?php echo $delivery_data->customer->address; ?></b></td>
                    </tr>
                    <tr>
                        <td style="background: #82ae46; color :white;">Catatan</td>
