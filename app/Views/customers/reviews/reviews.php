    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-sm-1">
                    <?php echo anchor('customer_reviews/write', 'Tulis Review Baru'); ?>
                </div>
                <div class="col-sm-5">
                        ...
                        <table class="table table-striped m-0">
                            ...
                            <?php foreach ($reviews as $review) : ?>
                                <tr>
                                    ...
                                    <td><?php echo anchor('customer_reviews/view/' . $review->id, '#' . $review->order_number); ?></td>
                ...
                <?php else : ?>
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <?php echo anchor('customer_reviews/write', 'Tulisan review baru'); ?>
                        </div>
                    </div>
                <?php endif; ?>
            </div>
